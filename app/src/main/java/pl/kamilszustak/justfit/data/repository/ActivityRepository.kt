...
class ActivityRepository @Inject constructor(
    ...
    private suspend fun mapAndSaveFetchResult(result: ActivityJson) {
    ...
    private suspend fun mapAndSaveFetchResult(result: List<ActivityJson>) {
